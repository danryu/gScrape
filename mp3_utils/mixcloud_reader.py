...
#    shownm = show['showname']
#    if shownm is not None:
#        if len(shownm) > 69:
#            print("oh shit")
#            print(show['showname'])
#            print(len(show['showname']))


r = requests.get('https://api.mixcloud.com/danryu/cloudcasts/?limit=500')

for cloudcast in r.json()['data']:
#    for cloudcast in entry['cloudcasts']:
    print (cloudcast['name'])
